...
import { investorRegistration } from '../../../../utils/Apis';
      ...
      setIsloading(true)
        ...
        .then((responseJson)=>{
            ...
            if(responseJson == "Successful"){
                ...
                navigation.navigate('investorsignuptwo', { email: email }); // Passing email id to the next page
