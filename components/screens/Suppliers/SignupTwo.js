...
import { Alert, Button, Text, TextInput, View,
 ...
 TouchableHighlight,Keyboard,ScrollView,Modal 
  ...
  import { supplierRegistrationTwo } from '../../../utils/Apis';
  const SupplierSignupTwo = ({route,navigation})=>{
  ...
  const submitData = ()=>{	
    ...
    .then((responseJson)=>{
        ...
        if(responseJson == "Successful"){
            ...
            navigation.navigate("suppliersignin");
...
export default SupplierSignupTwo;